...
if ($pgs_QRY ) {
    ...
    header("Location: ../../view/DependientesEconomicos/Listar.php?D-F=".$crypt.'&D-F3='.$id_tbl_control_plazas.'&MS3='.$messageError.'&RP='.$id_tbl_centro_trabajo); //Regreso a la tabla
}
} catch (\Throwable $th) {
