...
function modificarDependienteEconomicoByMas($connectionDBsPro,$id_tbl_dependientes_economicos,$nombre,$apellido_paterno,$apellido_materno,$id_cat_dependientes_economicos, $id_tbl_empleados){
