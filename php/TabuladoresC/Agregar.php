...
$r_sueldo_even = $_POST['r_sueldo_even'];
$c_sueldo_even = $_POST['c_sueldo_even'];
...
$pgs_QRY = pg_insert($connectionDBsPro, 'tbl_tabuladores', array(
    ...
    'r_sueldo_eve' => $r_sueldo_even,
    'c_sueldo_eve' => $c_sueldo_even,
    'r_sueldo' => $r_sueldo,
    'c_sueldo' => $c_sueldo,
