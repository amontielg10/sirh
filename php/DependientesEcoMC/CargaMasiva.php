                ...
                if (empty($rfc) || empty($curp) || empty($curpConyuge) || empty($apellidoPaterno)) {
                    ...
                    if (!empty($idTblEmpleado)) { ///VALIDACION DE RFC O CURP DE EMPLEADO
                        ...
                        if (validateCurp($curpConyuge)) {///VALIDACION DE CURP
                            ...
                            if ($edadMenor < $edadLimit) { ///COMPARACION DE EDAD DE MENOR QUE SEA MENOR A 12
                                ...
                                if ($consultaCurpMenor == 0) { /// VALIDA QUE LA CURP DEL MENOR NO ESTE REGISTRADA EN LA BASE DE DARTOS
                                    ...
                                    if (validaExistaCurpByCurp($curpConyuge) == 0){///VALIDACION PARA AGREGAR O MODIFICAR LA CURP DEL MENOR
                                        ...
                                        modificarDependienteEconomicoByMas($connectionDBsPro, $idDependienreEconomico, $nombre, $apellidoPaterno, $apellidoMaterno, $idTipoContratacion, $idTblEmpleado);
                                    }
                                    

                                    $idDependienreEconomico = idDependieEconomico($curpConyuge);
                                    insertarCtrlJuguetes($connectionDBsPro, $id_cat_fecha_juguetes, $idEstatusJuguete, $idTblEmpleado, $idDependienreEconomico,$idCtrlCargaMasiva);
                                    $registroExito++;
                                ...
                                insertarErrorDependieteEco($connectionDBsPro, $rfc, $curp, $curpConyuge, $nombre, $apellidoPaterno, $apellidoMaterno, $messgeEstatusError, $messageErrorMenor, $lineaExel, $idCtrlCargaMasiva);
                                $registroError++;
                            ...
                            insertarErrorDependieteEco($connectionDBsPro, $rfc, $curp, $curpConyuge, $nombre, $apellidoPaterno, $apellidoMaterno, $messgeEstatusError, $messageErrorMenorCurp, $lineaExel, $idCtrlCargaMasiva);
                            $registroError++;
                        ...
                        insertarErrorDependieteEco($connectionDBsPro, $rfc, $curp, $curpConyuge, $nombre, $apellidoPaterno, $apellidoMaterno, $messgeEstatusError, $messageErrorEmpleado, $lineaExel, $idCtrlCargaMasiva);
                        $registroError++;
