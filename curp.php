...
$spreadsheet->getActiveSheet()->getStyle('D1')->applyFromArray($styleTitle);
...
$spreadsheet->getActiveSheet()->getStyle('H1')->applyFromArray($styleTitle);
...
$rutaArchivo = 'exported_data.xlsx'; // Cambia esto por la ruta real de tu archivo

// Nombre del archivo que se descargará
$nombreArchivo = 'exported_data.xlsx'; // Cambia esto por el nombre que deseas para el archivo descargado
