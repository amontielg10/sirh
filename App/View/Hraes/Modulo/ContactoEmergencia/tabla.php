            ...
            '<tbody>
                        <tr>
                            ...
                            <div class="dropdown-menu">
                                ...
                                <button onclick="eliminarEmergencia(' . $row[0] . ')" class="dropdown-item btn btn-light boton-con-imagen"><img src="../../../../assets/icons/eliminar.png" alt="Imagen del botón">Eliminar</button>
                          </div>
                                </td>
                            <td>
                                ' . $row[1] . '
