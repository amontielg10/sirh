    ...
    <div class="modal-dialog modal-lg modal-dialog-centered">
        <div class="modal-content">
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-6">
                            ...
                            <input type="text" class="form-control" id="nombre_d" placeholder="Nombre" maxlength="20">
                        </div>
                        <div class="col-6">
                            <label class="text-input-form text-input-rem">Curp</label><label class="text-required">*</label>
                            <input type="text" class="form-control" id="curp_d" placeholder="Curp" maxlength="28">
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-6">
                            ...
                            <input type="text" class="form-control" id="apellido_paterno_d"
                                placeholder="Apellido paterno" maxlength="20">
                        </div>
                        <div class="col-6">
                            <label class="text-input-form text-input-rem">Tipo dependiente</label><label class="text-required">*</label>
                    ...
                    <div class="row">
                        <div class="col-6">
                            ...
                            <input type="text" class="form-control" id="apellido_materno_d"
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-success save-botton-modal" onclick="return validarDependienteD();"><i
