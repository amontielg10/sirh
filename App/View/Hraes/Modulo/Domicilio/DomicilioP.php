<div class="card border-light">
        ...
        <div class="row font-size-modulo">
            <div class="col-3">
                <label class="text-input-rem div-spacing">C&oacutedigo postal</label><label
        ...
        <div class="row">
            <div class="col-3">
                <label class="text-input-rem div-spacing">N&uacutem. exterior</label><label
                    class="text-required"></label>
                <input type="text" class="form-control" id="num_exterior1" placeholder="Núm. exterior" maxlength="10">
            </div>
            <div class="col-3">
                <label class="text-input-rem div-spacing">N&uacutem. interior</label><label
                    class="text-required"></label>
