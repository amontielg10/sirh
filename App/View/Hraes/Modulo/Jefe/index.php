...
<div class="form-inline">
    <button onclick="agregarEditarJefe(null)" class="btn btn-light"><i class="fas fa-plus"></i>
        <span class="hide-menu" style="font-weight: bold;">&nbsp;Agregar jefe inmediato</span>
    </button>
</div>
<p></p>
<input class="form-control mr-sm-2" type="search" placeholder="Buscar..." id="buscar_j"
    onkeyup="buscarJefe();" aria-label="Search">
<p></p>
