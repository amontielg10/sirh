    ...
    <div class="card border-light">
        <div class="card-body">
            <div class="row div-spacing">
                <div class="col-9">
                    <h2 class="card-title tittle-card-index">Cat&aacutelogos</h2>
                </div>
            </div>
                ...
                <div class="row">
                    <div class="col-2">
                        ...
                        <div class="card font-size-modulo shadow-lg">
                            <h6 class="card-header text-center background-modal color-text-tittle">Tipo de cat&aacutelogo
                            </h6>
                            <div class="nav flex-column nav-pills text-tittle-card-nav-x" id="v-tabs-tab" role="tablist"
                                ...
                                <a onclick="" class="nav-link-mod active" id="v-tabs-home-tab" data-toggle="pill"
                                    href="#nav_bank" role="tab" aria-controls="v-tabs-home" aria-selected="true">
                                    <i class="	fa fa-folder-open mr-2"></i> Bancos</a>
...
-->
                    ...
                    <div class="col-10">
                        <div class="tab-content" id="v-tabs-tabContent">
                            <div class="tab-pane fade show active" id="nav_bank" role="tabpanel"
