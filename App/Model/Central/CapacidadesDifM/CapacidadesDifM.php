...
class ModelCapacidadesM
{
    ...
    {
        $pg_update = pg_update($conexion, 'central.ctrl_capacidad_dif_hraes', $datos, $condicion);
        return $pg_update;
    }

    function agregarByArray($conexion, $datos)
    {
        $pg_add = pg_insert($conexion, 'central.ctrl_capacidad_dif_hraes', $datos);
        return $pg_add;
    }

    function eliminarByArray($conexion, $condicion)
    {
        $pgs_delete = pg_delete($conexion, 'central.ctrl_capacidad_dif_hraes', $condicion);
        return $pgs_delete;
    }
}
