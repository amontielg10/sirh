...
class ModelCedulaM
{
    function listarById($id_object, $paginator)
    {
        $listado = pg_query("SELECT id_ctrl_cedula_empleados_hraes, id_tbl_empleados_hraes,
                                    cedula_profesional
                            FROM central.ctrl_cedula_empleados_hraes
    ...
    {
        $pg_update = pg_update($conexion, 'central.ctrl_cedula_empleados_hraes', $datos, $condicion);
        return $pg_update;
    }

    function agregarByArray($conexion, $datos)
    {
        $pg_add = pg_insert($conexion, 'central.ctrl_cedula_empleados_hraes', $datos);
        return $pg_add;
    }

    function eliminarByArray($conexion, $condicion)
    {
        $pgs_delete = pg_delete($conexion, 'central.ctrl_cedula_empleados_hraes', $condicion);
        return $pgs_delete;
    }
}
