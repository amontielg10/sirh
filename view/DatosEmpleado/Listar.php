                                ...
                                while ($obj = pg_fetch_object($listado)) { ?>
                                    <tr>
                                        <td>
                                            ...
                                            <!-- MODAL ELIMINAR -->
                                            <div class="modal fade" id="<?php echo 'modal-' . $obj->id_tbl_datos_empleado ?>"
                                                    ...
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-footer">
                                                            ...
                                                            <a class="btn btn-danger"
                                                                href="<?php echo "../../php/DatosEmpleadoC/Eliminar.php?D-F=" . base64_encode($id_tbl_empleados) . "&D-F2=" . base64_encode($obj->id_tbl_datos_empleado) . '&D-F3=' . $id_tbl_control_plazas.'&RP='.$id_tbl_centro_trabajo ?>">Eliminar</a>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
