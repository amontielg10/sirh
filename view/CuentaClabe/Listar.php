                                    ...
                                    <tr>
                                        <td>
                                            ...
                                            <button type="button" class="btn btn-light" data-toggle="dropdown"
                                                ...
                                                <div class="dropdown-menu">
                                                        <a class="dropdown-item"
                                                        href="<?php echo "Editar.php?D-F=" . base64_encode($id_tbl_empleados) . "&D-F2=" . base64_encode($obj->id_ctrl_cuenta_clabe) ?>">Modificar</a>
                                                    <div class="dropdown-divider"></div>
                                                    <a class="dropdown-item"
                                                        href="<?php echo "../../php/ControlCuentaClabeC/Eliminar.php?D-F=" . base64_encode($id_tbl_empleados) . "&D-F2=" . base64_encode($obj->id_ctrl_cuenta_clabe) ?>">Eliminar</a>
                                                </div>
                                            </div>
